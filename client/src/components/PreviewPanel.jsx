  ...
  return (
    <div className='relative mx-auto w-full max-w-2xl'>
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
        ...
        {isLoading && (
            <div className='absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25'>
                ...
                <div className='text-center'>
                    ...
                    <p className='mt-1 tetx-xs text-zinc-400'>This may take 10-20 seconds</p>
                </div>
            </div>
        )}
        ...
        {/* empty state */}
        {!isLoading && !thumbnail?.image_url && (
            <div className='absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25 rounded-lg border-2 border-dashed border-white/20'>
